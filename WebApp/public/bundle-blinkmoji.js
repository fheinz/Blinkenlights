...
},{"timers":10}],2:[function(require,module,exports){
"use strict";
...
},{"../":5,"../parsers/uint8":6}],8:[function(require,module,exports){
...
},{"gifuct-js":3,"regenerator-runtime/runtime":9}],12:[function(require,module,exports){
"use strict";
...
var i = 0;
var gammaTable = Array.from(Array(256), function () {
  return Math.round(255 * Math.pow(i++ / 255.0, DEFAULT_GAMMA));
});
var socket = io();
var port;
var room;
...
socket.on("users list", function (users) {
  document.getElementById("roomTitle").innerHTML = "Users in room <i>" + room + "</i>";
...
},{"./blinken":11,"@joeattardi/emoji-button":1}]},{},[12,11]);
